...
public class QKART_Tests {
    ...
    public void TestCase02() throws InterruptedException {
        ...
        // return !status;
        Assert.assertFalse("User Re-registration Failed", status);
    }
    ...
    public void TestCase03() throws InterruptedException {
        ...
        //     return false;
        // }
        Assert.assertTrue("Failed",status);
        ...
        for (WebElement webElement : searchResults) {
            ...
            //     return false;
            // }
            //Assert.assertFalse(!elementText.toUpperCase().contains("YONEX"));
        }
    ...
    public void TestCase04() throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                Assert.assertTrue("Passed", result.verifySizeChartExists());
    ...
    public void TestCase05() throws InterruptedException {
        ...
        status = login.PerformLogin(lastGeneratedUserName, "abc@123");
        if (!status) {
            Assert.assertFalse("Failed", status);
    ...
    public void TestCase10() throws InterruptedException {
        ...
        Assert.assertTrue("Failed", wait.until(ExpectedConditions.invisibilityOf(contactUs)));
        logStatus("End TestCase",
                "Test Case 10: Verify that contact us option is working correctly ",
                status ? "PASS" : "Fail");
    ...
    @Test(priority=11, groups = {"Sanity_test" , "Regression_Test"})
